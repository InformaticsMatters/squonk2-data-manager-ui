...
The _Project Data_ tab allows you to see that data and perform simple operations on it.
...
Not all operations you might want to do are possible from the _Project Data_ tab.
