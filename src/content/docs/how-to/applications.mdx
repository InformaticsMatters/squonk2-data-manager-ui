...
import jupyter_app from "../../../pages/docs/assets/jupyter-app.png";
import jupyter_launch from "../../../pages/docs/assets/jupyter-launch.png";
import jupyter_launched from "../../../pages/docs/assets/jupyter-launched.png";
import jupyter_instance from "../../../pages/docs/assets/jupyter-instance.png";
import jupyter_lab from "../../../pages/docs/assets/jupyter-lab.png";
...
To launch this application locate it in a project's **Run** section and click _Run_:
...
Click in it to take you to the details of the running instance under **Results**.
