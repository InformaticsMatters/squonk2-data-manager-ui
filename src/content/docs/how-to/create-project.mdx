...
import create from "../../../pages/docs/assets/project-create.png";
import users from "../../../pages/docs/assets/project-users.png";
...
The _Create Project_ button will be present in the _Context_ section of the _Settings panel_ if you are able to create a
...
project listing and add the users you want to the _Administrators_, _Editors_ and _Observers_ sections.
