 ...
 * billing unit of the last successful upload, this account's dismissal of the onboarding offer, and
 * the records of a project creation or deletion this account left in flight. Preferences that
 * belong to the browser rather than to the account — consent, debug mode, colour scheme — are left
 * alone, which is why the keys are named here rather than the store being emptied.
 *
...
export const clearAccountScopedStorageOnLogout = (
  ...
  local.removeItem(PROJECT_ONBOARDING_DISMISSAL_KEY);
