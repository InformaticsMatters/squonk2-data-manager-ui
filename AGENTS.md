...
- `pnpm test:journey` (`playwright.journey.config.ts`) runs the mutating live user journey against the DLS test deployment — manual and scheduled only, never a merge gate. See `docs/testing.md`.
