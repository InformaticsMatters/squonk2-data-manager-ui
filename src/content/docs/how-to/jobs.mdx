...
import job_launch from "../../../pages/docs/assets/job-launch.png";
...
Open a project and use its **Run** section to launch **Jobs** to do your work. Whatever you launch
runs in the project you are in.
...
the card. Click on it to see the execution details under **Results**. See the
