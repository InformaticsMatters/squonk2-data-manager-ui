...
Data is at the heart of the Squonk Data Manager. Your datasets stay in the same place, and applications fire up around the data. This is the _"bring the compute to the data"_ paradigm.
