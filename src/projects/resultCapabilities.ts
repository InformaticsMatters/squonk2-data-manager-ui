...
export const resolveResultCapabilities = (
  facts: ProjectFacts,
  {
    ...
    /** How the concrete instance accounted for its own progress, where the result is one. */
  ...
  return {
    ...
    termination: evaluateResultTerminationCapability({
      ...resultFacts,
      settlement: instanceSettlement,
    }),
