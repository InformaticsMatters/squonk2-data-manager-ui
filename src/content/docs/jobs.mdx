...
The list of available jobs on this Squonk Data Manager can be found in the **Run** section of any
project you can reach. See the [Running jobs](/docs/how-to/jobs) How To guide.
