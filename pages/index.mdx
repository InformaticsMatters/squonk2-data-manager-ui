...
* Generate 3D conformers ([see here](https://discourse.squonk.it/t/job-generate-low-energy-conformers/86))
...
- [Guided Tour](docs/guided-tour) - Walk through of the different screens
- [How to](docs/how-to) - How to guides for various tasks
- [Deployed jobs](docs/jobs) - details of the jobs that have been deployed to this Squonk Data Manager instance
...
5. Use the **Executions** tab to launch a Jupyter notebook or execute pre-defined jobs that work on those datasets.
