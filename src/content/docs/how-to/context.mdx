...
The best way to do this is to use the **Settings** menu in the top right corner.
...
Also note the _filter_ option at the top that allows to filter the projects tht are shown based on your role in the project.
