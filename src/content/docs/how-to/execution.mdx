...
import results_1 from "../../../pages/docs/assets/results-1.png";
import results_2 from "../../../pages/docs/assets/results-2.png";
...
A project's **Results** section shows the execution of your **Applications** and **Jobs**. A high level summary of each running app or
