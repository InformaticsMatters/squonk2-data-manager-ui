...
A project's **Files** section allows you to see that data and perform simple operations on it.
...
Not all operations you might want to do are possible from **Files**.
