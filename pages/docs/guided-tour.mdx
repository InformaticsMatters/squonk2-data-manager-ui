...
More detailed descriptions can be found in the individual <InternalLink href="./how-to">How to guides</InternalLink>
...
More details can be found in the <InternalLink href="./how-to/login">Logging in</InternalLink> How To guide.
...
More details can be found in the <InternalLink href="./how-to/context">Setting your work context</InternalLink> How To guide.
...
See the <InternalLink href="./how-to/jobs">Running jobs</InternalLink> How To guide for more details.

Launching an **Application** is very similar. Currently the only available application is a Jupyter Notebook.
See the <InternalLink href="./how-to/applications">Running applications</InternalLink> How To guide for more details.
...
See the <InternalLink href="./how-to/results">Inspecting job and application execution</InternalLink> How To guide for more details.
